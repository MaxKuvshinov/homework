...
class TestConvertToRub(unittest.TestCase):
    ...
    @patch("requests.get")
    def test_convert_eur_in_rub(self, mock_get: MagicMock) -> None:
    ...
    def test_convert_rub_in_rub(self) -> None:
        transaction = {"operationAmount": {"amount": 100, "currency": {"code": "RUB"}}}

        result = conversion_in_rub(transaction)
        self.assertEqual(result, 100)

    def test_convert_other_currency_in_rub(self) -> None:
